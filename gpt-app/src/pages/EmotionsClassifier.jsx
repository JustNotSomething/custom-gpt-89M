...
export default function EmotionsClassifier() {
...
const handleSend = async () => {
  ...
  try {
        const res = await fetch('http://localhost:8000/classify-emotion', {
            method: 'POST',
            ...
            setMessages(prev => [
            ...prev,
            { type: 'system', text: `Detected emotion: ${data.label} (confidence: ${(data.confidence * 100).toFixed(1)}%)` }
        ]);
  ...
  return (
    <div className="EmotionsClassifier">
      <div className="overlay">
        ...
        <h3 className="page-title">Emotions Classifier</h3>
